...
# Route vers la page administrations de vérification envoie formulaire pour demande de vente ou d'estimation d'un bien
index.php?route=check-contact

# Route vers la page du formulaire pour faire gerer un bien
index.php?route=contact-manage

# Route vers la page administrations de vérification envoie formulaire pour demande de gestion d'un bien
index.php?route=check-contact-manage

# Route vers la page du formulaire de contact
index.php?route=contact

# Route vers la page administrations de vérification envoie formulaire de contact
index.php?route=check-contact
...
# Route vers la page administrations pour la gestion des biens
index.php?route=admin-property-type

# Route vers la page administrations pour la liste des biens par type
...
# Route vers la page administrations de vérification d'ajout d'un bien 
...
# Route vers la page administrations de vérification de mise à jour d'un bien 
...
# Route vers la page administrations de vérification de la suppression  d'un bien 
index.php?route=check-delete-property&type={{ propertyById.type.typeName }}

# Route vers la page administrations pour la gestion des utilisateurs
index.php?route=admin-users-role

# Route vers la page administrations pour la liste des utilisateurs avec le role proprietaire
index.php?route=users-proprietaire&role=proprietaire

# Route vers la page administrations pour la liste des utilisateurs avec le role locataire
index.php?route=users-locataire&role=locataire

# Route vers la page administrations pour la liste des utilisateurs avec le role reader
index.php?route=users-admin&role=reader

# Route vers la page administrations pour la liste des utilisateurs avec le role admin
index.php?route=users-admin&role=admin

# Route vers la page administrations pour l'ajout d'un administrteur
index.php?route=register

# Route vers la page de vérification d'ajout d'un administrteur
index.php?route=check-register

# Route vers la page administrations pour mettre à jour un administrteur
index.php?route=update-admin&id={id}

# Route vers la page de vérification de mise à jour d'un administrteur
